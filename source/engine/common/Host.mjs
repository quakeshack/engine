...
export default class Host {
  static developer = null;
  static dedicated = null;
  static framecount = 0;
  static framerate = null;
  ...
  static pausable = null;
  static realtime = 0.0;
  static refreshrate = null;
  static speeds = null;
  static teamplay = null;
  static ticrate = null;
  static version = null;
  ...
  static SendChatMessageToClient(client, name, message, direct = false) {
   ...
   * @param {string} reason
   */
  static DropClient(client, crash, reason) { // TODO: refactor into ServerClient
  ...
  static ShutdownServer(isCrashShutdown = false) { // TODO: SV duties
    if (SV.server.active !== true) {
      return;
    }
  ...
  static WriteConfiguration_f() {
    Con.Print('Writing configuration\n');
    Host.WriteConfiguration();
  };

  static ServerFrame() { // TODO: move to SV.ServerFrame
  ...
  static _scheduledForNextFrame = [];
  static ScheduleForNextFrame(callback) {
    Host._scheduledForNextFrame.push(callback);
  };

  static _scheduleInFuture = new Map();
  static ScheduleInFuture(name, callback, whenInSeconds) {
    if (Host.isdown) {
  ...
  static Map_f(mapname, ...spawnparms) {
  ...
  static async Loadgame_f(savename) {
    if (this.client) {
      return;
    }
    if (savename === undefined) {
  ...
  static Name_f(...names) { // signon 2, step 1
  ...
  static Say_Team_f(message) {
    Host.Say_f.call(this, true, message);
  };

  static Say_All_f(message) {
    Host.Say_f.call(this, false, message);
  };

  static Tell_f(recipient, message) {
    if (this.forward()) {
      return;
    }
  ...
  static Color_f(...argv) { // signon 2, step 2
  ...
  static PreSpawn_f() { // signon 1, step 1
    if (!this.client) {
  ...
  static Spawn_f() { // signon 2, step 3
  ...
  static Begin_f() {  // signon 3, step 1
  ...
  static async Viewmodel_f(model) {
    if (model === undefined) {
