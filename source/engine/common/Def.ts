 ...
 * Version string.
 */
export const productVersion = '1.2.2';
...
/**
 * Bit shifts used by legacy contents flags.
 */
...
/**
 * High-level client connection states.
 */
